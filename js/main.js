...
const translations = {
  en: {
    ...
    'gallery.item1.aria': 'Open visual preview: Castle construction',
    'gallery.item1.alt': 'A castle under construction above a medieval settlement',
    'gallery.item1.caption': 'Castle construction',
    'gallery.item2.aria': 'Open visual preview: Settlement growth',
    'gallery.item2.alt': 'A medieval village beside water and fields',
    'gallery.item2.caption': 'Settlement growth',
    'gallery.item3.aria': 'Open visual preview: Third-person exploration',
    'gallery.item3.alt': 'A third-person view across a medieval village and castle',
    'gallery.item3.caption': 'Third-person exploration',
    'gallery.item4.aria': 'Open visual preview: Defense encounter',
    'gallery.item4.alt': 'A player character facing danger in a forest clearing',
    'gallery.item4.caption': 'Defense encounter',
    'gallery.item5.aria': 'Open visual preview: Castle and village',
    'gallery.item5.alt': 'A growing village below a hilltop castle',
    'gallery.item5.caption': 'Castle and village',
    ...
    'support.steam.demo': 'Play the Steam Demo',
    ...
    'support.updates.title': 'Watch Updates',
    'support.updates.desc': 'Follow new clips, feature previews, and development notes on the official Arkem channel.',
    'support.updates.cta': 'Open YouTube',
    ...
    'support.kofi.title': 'Merch',
    'support.kofi.desc': 'Official merchandise gives supporters another way to carry the Arkem banner.',
    'support.kofi.cta': 'Visit Merch Store',
  ...
  pl: {
    ...
    'gallery.item1.aria': 'Otwórz podgląd: budowa zamku',
    'gallery.item1.alt': 'Zamek w budowie ponad średniowieczną osadą',
    'gallery.item1.caption': 'Budowa zamku',
    'gallery.item2.aria': 'Otwórz podgląd: rozwój osady',
    'gallery.item2.alt': 'Średniowieczna wieś nad wodą i polami',
    'gallery.item2.caption': 'Rozwój osady',
    'gallery.item3.aria': 'Otwórz podgląd: eksploracja z trzeciej osoby',
    'gallery.item3.alt': 'Widok z trzeciej osoby na średniowieczną wieś i zamek',
    'gallery.item3.caption': 'Eksploracja z trzeciej osoby',
    'gallery.item4.aria': 'Otwórz podgląd: starcie obronne',
    'gallery.item4.alt': 'Postać gracza mierząca się z zagrożeniem na leśnej polanie',
    'gallery.item4.caption': 'Starcie obronne',
    'gallery.item5.aria': 'Otwórz podgląd: zamek i osada',
    'gallery.item5.alt': 'Rozrastająca się wieś poniżej zamku na wzgórzu',
    'gallery.item5.caption': 'Zamek i osada',
    ...
    'support.steam.demo': 'Zagraj w demo na Steam',
    ...
    'support.updates.title': 'Oglądaj aktualizacje',
    'support.updates.desc': 'Śledź nowe klipy, podglądy funkcji i notatki deweloperskie na oficjalnym kanale Arkem.',
    'support.updates.cta': 'Otwórz YouTube',
    ...
    'support.kofi.title': 'Merch',
    'support.kofi.desc': 'Oficjalne produkty dają wspierającym kolejny sposób, by nieść sztandar Arkem.',
    'support.kofi.cta': 'Odwiedź sklep',
    ...
    'footer.steamDemo': 'Demo na Steam',
    'footer.merch': 'Merch',
  ...
  de: {
    ...
    'gallery.item1.aria': 'Visuelle Vorschau öffnen: Burgbau',
    'gallery.item1.alt': 'Eine Burg im Bau oberhalb einer mittelalterlichen Siedlung',
    'gallery.item1.caption': 'Burgbau',
    'gallery.item2.aria': 'Visuelle Vorschau öffnen: Siedlungswachstum',
    'gallery.item2.alt': 'Ein mittelalterliches Dorf am Wasser und an Feldern',
    'gallery.item2.caption': 'Siedlungswachstum',
    'gallery.item3.aria': 'Visuelle Vorschau öffnen: Third-Person-Erkundung',
    'gallery.item3.alt': 'Eine Third-Person-Ansicht über ein mittelalterliches Dorf und eine Burg',
    'gallery.item3.caption': 'Third-Person-Erkundung',
    'gallery.item4.aria': 'Visuelle Vorschau öffnen: Verteidigungsbegegnung',
    'gallery.item4.alt': 'Eine Spielerfigur stellt sich einer Gefahr auf einer Waldlichtung',
    'gallery.item4.caption': 'Verteidigungsbegegnung',
    'gallery.item5.aria': 'Visuelle Vorschau öffnen: Burg und Dorf',
    'gallery.item5.alt': 'Ein wachsendes Dorf unterhalb einer Höhenburg',
    'gallery.item5.caption': 'Burg und Dorf',
    ...
    'support.steam.demo': 'Steam-Demo spielen',
    ...
    'support.updates.title': 'Updates ansehen',
    'support.updates.desc': 'Verfolge neue Clips, Feature-Vorschauen und Entwicklernotizen auf dem offiziellen Arkem-Kanal.',
    'support.updates.cta': 'YouTube öffnen',
    ...
    'support.kofi.title': 'Merch',
    'support.kofi.desc': 'Offizielle Produkte geben Unterstützern eine weitere Möglichkeit, das Arkem-Banner zu tragen.',
    'support.kofi.cta': 'Merch-Store öffnen',
...
function spawnEmber() {
  ...
  ember.style.cssText = `
    ...
    border-radius:50%;
    background:rgba(158,182,204,0.72);
    pointer-events:none;
